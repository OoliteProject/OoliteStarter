...
public class ExpansionTest {
    ...
    public void testToString() {
        ...
        Expansion expansion = new Expansion();
        assertEquals("oolite.starter.model.Expansion(null, null, null, null)", expansion.toString());
        
        expansion.setIdentifier("identifier");
        assertEquals("oolite.starter.model.Expansion(identifier, null, null, null)", expansion.toString());
        
        expansion.setVersion("version");
        assertEquals("oolite.starter.model.Expansion(identifier, version, null, null)", expansion.toString());
        
        expansion.setDownloadUrl("url");
        assertEquals("oolite.starter.model.Expansion(identifier, version, url, null)", expansion.toString());
    }
