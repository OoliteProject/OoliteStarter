...
import static oolite.starter.Oolite2.getDebugSupportFromHelpMenu;
...
Built with Clang version 14.0.0
    ...
    @Test
    public void testGetDebugSupportFromHelpMenu() {
        log.info("testGetDebugSupportFromHelpMenu");
        
        try {
            Oolite2.getDebugSupportFromHelpMenu(null);
            fail("exception expected");
        } catch (IllegalArgumentException e) {
            assertEquals("helpMenu must not be null", e.getMessage());
            log.debug("caught expected exception", e);
    ...
    @Test
    public void testGetDebugSupportFromHelpMenu1() {
        log.info("testGetDebugSupportFromHelpMenu1");
        
        String result = Oolite2.getDebugSupportFromHelpMenu("");
        assertNull(result);
    }

    @Test
    public void testGetDebugSupportFromHelpMenu2() {
        log.info("testGetDebugSupportFromHelpMenu2");
...
Built with Clang version 14.0.0
        ...
        String result = Oolite2.getDebugSupportFromHelpMenu(h);
        assertNull(result);
    }


    @Test
    public void testGetDebugSupportFromHelpMenu3() {
        log.info("testGetDebugSupportFromHelpMenu3");
...
Options marked with "*" are available only in Test Release configuration.
Version 1.92.1.7797-260228-9ca54c9
Debug functionality enabled (Test Release): yes
Built with Clang version 14.0.0
                                      """;
