 ...
 *
 * <p>Inspired by http://www.camick.com/java/source/TableColumnManager.java
 *
...
public class TableColumnManager
     ...
     *
     *  <p>Generally this method should only be invoked by the TableColumnManager
    ...
    private void showColumn(TableColumn column) {
        ...
        for (int i = position - 1; i > -1; i--) {
            try {
                ...
                log.debug("Could not add column", e);
            }
        }
